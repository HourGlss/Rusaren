...
- Run `server/scripts/export-web-client.ps1` on Windows or `bash server/scripts/export-web-client.sh --godot-bin godot4` on Linux to build the browser shell into `server/static/webclient/`.
