...
mod tests {
    ...
    fn build_test_index(project_root: &Path) -> Index {
        ...
        root_symbol.symbol = String::from("rust-analyzer cargo game_api 0.6.0 app/root().");
        ...
        helper_symbol.symbol = String::from("rust-analyzer cargo game_api 0.6.0 app/helper().");
        ...
        enum_symbol.symbol = String::from("rust-analyzer cargo game_api 0.6.0 app/RoundWon.");
        ...
        test_symbol.symbol =
            String::from("rust-analyzer cargo game_api 0.6.0 app/tests/root_test().");
        ...
        document.occurrences = vec![
            definition(0, "rust-analyzer cargo game_api 0.6.0 app/root()."),
            reference(1, "rust-analyzer cargo game_api 0.6.0 app/helper()."),
            reference(
                2,
                "rust-analyzer cargo core https://github.com/rust-lang/rust/library/core option/impl#[`Option<T>`]unwrap_or_else().",
            ),
            reference(3, "rust-analyzer cargo game_api 0.6.0 app/RoundWon."),
            definition(6, "rust-analyzer cargo game_api 0.6.0 app/helper()."),
            definition(11, "rust-analyzer cargo game_api 0.6.0 app/tests/root_test()."),
            reference(12, "rust-analyzer cargo game_api 0.6.0 app/helper()."),
        ];
    ...
    fn normalize_symbol_name_formats_methods_and_functions() {
        assert_eq!(
            normalize_symbol_name(
                "rust-analyzer cargo game_api 0.6.0 app/ServerApp#handle_packet()."
            ),
            "game_api::app::ServerApp::handle_packet"
        );
        assert_eq!(
            normalize_symbol_name("rust-analyzer cargo game_api 0.6.0 app/spawn_dev_server()."),
    ...
    fn build_graph_filters_tests_and_enum_members_and_tracks_local_edges() -> Result<(), String> {
        ...
        assert!(root
            .outgoing
            .contains("rust-analyzer cargo game_api 0.6.0 app/helper()."));
        assert!(result
            .nodes
            .values()
